...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${post.title.rendered} - Base.Tube Blog`,
    ...
    <Layout>
      ...
      <div className="post-hero">
        ...
        <div className="post-hero-content">
          ...
          <h1 className="post-hero-title">{post.title.rendered}</h1>
          ...
          <div className="article-footer">
            ...
            <div className="article-share">
              ...
              <div className="share-buttons">
                <a href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://base.tube/blog/${resolvedParams.slug}`)}&text=${encodeURIComponent(post.title.rendered)}`} 
                ...
                <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://base.tube/blog/${resolvedParams.slug}`)}`}
                ...
                <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://base.tube/blog/${resolvedParams.slug}`)}`}
