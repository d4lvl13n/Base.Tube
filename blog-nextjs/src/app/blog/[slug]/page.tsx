          ...
          <div className="article-footer">
            ...
            <div className="article-share">
              ...
              <div className="share-buttons">
                <a href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://base.tube/blog/${post.slug}`)}&text=${encodeURIComponent(post.title.rendered)}`} 
                ...
                <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://base.tube/blog/${post.slug}`)}`}
                ...
                <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://base.tube/blog/${post.slug}`)}`}
